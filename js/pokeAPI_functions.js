// Si queréis documentar funciones es mejor usar el standard JSDoc
// así 👇
/**
 * Funció qeu retorna un valor pseudoaleatori que pertany al domini [max,min]
 * Per fer que el valor maxim pertanyi al domini, li afegim +1
 * @param {Number} max //valor màxim que pot donar la funció
 * @param {Number} min //valor mínim que pot donar la funció
 * @returns {Number}
 */
